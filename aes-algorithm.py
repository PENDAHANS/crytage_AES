...
def decryptFile(password, IV, filename):
    ...
    return 'operation effectuer'
repertoire=("cd C:/Users/HANS PENDA/Downloads/AES/")
...
if sys.argv[1] == 'crypter_dossier':
   print(encryptFile(sys.argv[2],b'P0123as235a145df',sys.argv[3]))
   #os.system('cmd /k'+repertoire+'' and 'cmd /k "cipher /e"' )
   print('operation effectuer')
elif sys.argv[1] == 'decrypter_dossier':
    print(decryptFile(sys.argv[2],b'P0123as235a145df',sys.argv[3]))
   #os.system('cmd /k'+repertoire+'' and 'cmd /k "cipher /d"' )
else:
    print('mauvais choix!')